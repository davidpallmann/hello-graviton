...
WORKDIR /src
COPY ["hello-graviton.csproj", "hello-graviton/"]
RUN dotnet restore "hello-graviton/hello-graviton.csproj"

WORKDIR "/src/hello-graviton"
COPY . .
RUN dotnet build "hello-graviton.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "hello-graviton.csproj" \
...
Execute unit tests
```
cd "hello-graviton/test/hello-graviton.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "hello-graviton/src/hello-graviton"
